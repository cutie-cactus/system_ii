...
- Если пользователь говорит "хочу короткую книгу" → "pages_to": "138"
- "Давай что-то длинное" → "pages_from": "500"
- "Не очень длинная книга" → "pages_to": "450"
...
5. Запрос: "хочу короткую книгу про любовь"
Ответ: {
  "question_type": "search",
  "filter": {
    "author": [],
    "genre": ["любовный_роман"],
    "year_from": "",
    "year_to": "",
    "language": [],
    "age_restriction": [],
...
6. Запрос: "Привет, как дела?"
Ответ: {
  "question_type": "other",
  "filter": {},
  "compare": {},
  "feedback": {},
  "num_question": "не_распознано",
  "step_back": ""
}