"""
Метрики расстояний между книгами
"""
import pandas as pd
import numpy as np
...
class BookDistanceMetrics:
    ...
    def taxonomic_distance(self, genre1, genre2, max_depth=4):
        """
        Таксономическое расстояние между жанрами
        """
    ...
    def create_distance_matrix(self, weights=None):
        ...
        for i in range(n):
            for j in range(i + 1, n):
                dist = self.composite_distance(i, j, weights)
