...
class BookRecommendationInterface:
    ...
    def _process_user_query(self, user_query: str):
        ...
        try:
            parsed_query = json.loads(parsed_result)
        except json.JSONDecodeError as e:
            print(f"❌ Ошибка парсинга JSON: {e}")
            print(f"📝 Сырой ответ парсера: {parsed_result}")
            return
    ...
    def _show_parsed_query(self, parsed_query: Dict[str, Any]):
        ...
        Args:
            parsed_query: результат парсинга
        """
    ...
    def _clear_filters(self):
        ...
        self.recommendation_system.process_query(clear_query)
...
def main():
    ...
    try:
        ...
        print("Убедитесь, что модули доступны")
    except Exception as e:
